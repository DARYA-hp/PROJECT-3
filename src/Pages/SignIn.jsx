    ...
    return (
        <div className="relative bg-[url('/23.jpg')] h-screen bg-no-repeat bg-cover">
            <div className="absolute inset-0 bg-black/60">
                <div className="ml-[480px] mt-28 w-[411px]">
                    <div className="text-center mb-8">
                        <img src="/Logo (2).png" alt="" className="pb-12 ml-[100px]" />
                        <p className="text-[24px] font-[700] text-[#e7e0e0]">Welcome Back</p>
                    </div>
                    ...
                    <form className="flex flex-col gap-3">
                        ...
                        <button type="submit" className="mt-5 text-white rounded-2xl bg-[#1DAEFF] w-[411px] py-3">
                            SIGN IN
                        </button>
                    </form>
