            ...
            <div className="relative w-full h-screen bg-[url('/40.jpg')] bg-center bg-cover bg-no-repeat flex items-center justify-center">
                ...
                <div className="relative w-[420px] p-8 bg-transparent">
                    <div className="text-center mb-8">
                        <img src="/Logo (2).png" alt="" className="mx-auto" />
                        <p className="text-[24px] font-[700] pt-8 text-[#e7e0e0]">Welcome Back</p>
                    </div>
                    ...
                    <form className="flex flex-col gap-3">
                        ...
                        <div className="pt-3 flex justify-between items-center text-white text-sm">
                        ...
                        <button type="submit" className="mt-5 text-white rounded-2xl bg-[#1DAEFF] w-full py-3">
                            SIGN IN
                        </button>
                    </form>
                    ...
                    <div className="text-center mt-3">
                        <p className="text-[#8F90A6]">
                            ...
                            <span className="text-[#1DAEFF] cursor-pointer" onClick={() => navigate("/Signup")}>
                                Sign up
                            </span>
                        </p>
                    </div>
