      ...
      <div  className=" w-full  bg-white transition-colors duration-300">
        <div className="  sm:px-6 lg:px-20">
            <div className=" text-center">
                <img src="public/image18.png" alt="" className=" m-auto pt-20 w-[90px] h-[180px]"/>
                <div>
                    <h1 className=" pt-8 text-5xl font-Montserrat font-semibold text-[#000000DE] leading-10 dark:text-[#FFFFFFDE]">What our members said ?</h1>
