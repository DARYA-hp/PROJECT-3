                    ...
                    <div className="relative">
                        <div>
                            ...
                            <div className="absolute -top-[78px] left-[485px] -translate-x-1/2 bg-white backdrop-blur-md shadow-xl px-7 py-6 text-center scale-125">
                                ...
                                <p className="text-[#054457] text-sm leading-loose">
                                    500+ Reviews
                                </p>
                        ...
                        <div className="flex bg-white justify-around py-5 px-7 absolute top-[395px] left-44 gap-3">
                            <div className="flex text-center items-center">
                                <h1 className="text-6xl font-semibold text-[#054457]">300+</h1>
                                <p className="text-[#A6A6A6] w-1/3 leading-6 text-base font-normal">
                                    Property Sale
                                </p>
                            </div>
                            <div className="flex text-center items-center">
                                <h1 className="text-6xl font-semibold text-[#054457]">550+</h1>
                                <p className="text-base text-[#A6A6A6] w-1/3 leading-6 font-normal">
                                    Apartment Rent
                                </p>
                            </div>
                        </div>
