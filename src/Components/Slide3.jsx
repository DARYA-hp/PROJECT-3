    ...
    return (
        <>
                    ...
                    {properties.map((property, index) => (
                        ...
                        >
                            <div className="relative">
                                ...
                                />
                                {property.id === 1 && (
                                    <div className="absolute inset-0 bg-[#0aceff55] rounded-2xl"></div> // لایه آبی روشن
                                )}
                            </div>
                            <div className="pl-10 flex flex-col gap-4">
                                ...
                                <div className="flex flex-row items-center gap-x-8">
                                    <p className="text-[17px] text-[#8F90A6] font-[520]">
                                        Posted by {property.builder}
                                    </p>
            ...
            <div className="px-28 pt-28">
                <div className="rounded-3xl bg-gradient-to-b from-[#9dc8df] to-[#DFF0F7] h-[480px] flex flex-row justify-between">
